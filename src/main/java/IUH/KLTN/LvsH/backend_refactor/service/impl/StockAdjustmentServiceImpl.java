...
import IUH.KLTN.LvsH.backend_refactor.entity.*;
import IUH.KLTN.LvsH.backend_refactor.enums.DocumentStatus;
import IUH.KLTN.LvsH.backend_refactor.repository.*;
...
public class StockAdjustmentServiceImpl implements StockAdjustmentService {
    ...
    public StockAdjustmentResponseDTO completeAdjustment(Long id) {
        ...
        for (StockAdjustmentItem item : items) {
            ...
            IUH.KLTN.LvsH.backend_refactor.enums.InventoryMovementType type = item.getDiffQty() > 0
                    ? IUH.KLTN.LvsH.backend_refactor.enums.InventoryMovementType.ADJUST_IN
                    : IUH.KLTN.LvsH.backend_refactor.enums.InventoryMovementType.ADJUST_OUT;
