...
import IUH.KLTN.LvsH.dto.customer_return.CustomerReturnSearchCriteria;
...
public class CustomerReturnSpecification {
    public static Specification<CustomerReturn> withCriteria(CustomerReturnSearchCriteria criteria) {
